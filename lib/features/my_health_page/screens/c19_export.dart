...
class C19Export extends StatefulWidget {
  @override
  C19ExportState createState() => C19ExportState();
}

class C19ExportState extends State<C19Export> {
...
// Add user information to the PDF
          ...
          build: (context) {
            ...
            return pdfWidgets.Column(
              ...
              children: [
                ...
                pdfWidgets.Text(
                    'Test Taken:  ${DateFormat('yyyy-MM-dd HH:mm:ss').format(DateTime.fromMillisecondsSinceEpoch(results['dateTime'].seconds * 1000))}'),
      ...
      final message = Message()
        ..from = const Address('Elarosteamb@outlook.com',
