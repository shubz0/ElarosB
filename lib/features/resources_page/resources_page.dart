        ...
        child: ListView(
          children: [
            ...
            const CustomExpansionTile(
              ...
              link:
                  "https://www.youtube.com/watch?v=DwG04FDMc2Y&ab_channel=UTHealthAustin",
            ),
            const SizedBox(height: 7),
            const CustomExpansionTile(
              ...
              backgroundColor: Color.fromARGB(255, 0, 169, 165),
              link:
                  "https://www.youtube.com/watch?v=XtQNReF1N6E&ab_channel=TopDoctorsUK",
            ),
            const SizedBox(height: 7),
            const SizedBox(height: 7),
            const CustomExpansionTile(
              ...
              backgroundColor: Color.fromARGB(255, 0, 169, 165),
              link:
                  "https://www.youtube.com/watch?v=I6pennFFsqc&ab_channel=TopDoctorsUK",
            ),
            const SizedBox(height: 7),
            const CustomExpansionTile(
              label: 'Drowsiness',
              ...
              backgroundColor: Color.fromARGB(255, 0, 169, 165),
              link:
                  "https://www.youtube.com/watch?v=6NDlFADXIhc&ab_channel=MedicalCentric",
            ),
            const SizedBox(height: 7),
            const CustomExpansionTile(
              ...
              backgroundColor: Color.fromARGB(255, 0, 169, 165),
              link:
                  "https://www.youtube.com/watch?v=5rH7AekoHbs&ab_channel=Rehealthify",
            ),
            const SizedBox(height: 7),
            const CustomExpansionTile(
              label: 'Headaches',
              ...
              backgroundColor: Color.fromARGB(255, 0, 169, 165),
              link:
                  "https://www.youtube.com/watch?v=JMfmDAJo3qc&ab_channel=ArmandoHasudungan",
            ),
            const SizedBox(height: 7),
          ],
        ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (link != null) const SizedBox(height: 8),
                InkWell(
                  onTap: () async {
