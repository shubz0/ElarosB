                  ...
                  GestureDetector(
                    ...
                    decoration: BoxDecoration( 
                      ...
                      child: Wrap(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left: 25.0, top: 20.0, bottom: 10.0),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text("Blood Group", style: TextStyle(fontSize: 13.0),),
                                FutureBuilder(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text("Weight", style: TextStyle(fontSize: 13.0),),
                                Row(
                                  children: [
                                    FutureBuilder(
              ...
              Wrap(
                ...
                children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                const SizedBox(height: 10,),
                                const Text("Mi-Trialʨ", style: TextStyle(fontSize: 12.0, fontWeight: FontWeight.w600, color: Color(0xff3C5C6C)),),
                              ],
                            )
                          ),
                        ),
                  ...
                  MouseRegion(
                    ...
                    child: InkWell(
                      onTap: () {
                        launch('https://www.elaros.com/solutions/neu-restore/');
                      },
                      splashColor: const Color.fromARGB(255, 0, 0, 0),
                      child: Container(
                        width: 80,
                  ...
                  MouseRegion(
                    ...
                    child: InkWell(
                      onTap: () {
                        launch('https://www.elaros.com/solutions/cqi-toolkit/');
                      },
                      splashColor: const Color.fromARGB(255, 0, 0, 0),
                      child: Container(
                        width: 80,
                  ...
                  MouseRegion(
                    ...
                    child: InkWell(
                      onTap: () {
                        launch('https://www.elaros.com/solutions/sleepy-fox/');
                      },
                      splashColor: const Color.fromARGB(255, 0, 0, 0),
                      child: Container(
                        width: 80,
                  ...
                  MouseRegion(
                    ...
                    child: InkWell(
                      onTap: () {
                        launch('https://www.elaros.com/solutions/the-care-home-guide-to-dysphagia/');
                      },
                      splashColor: const Color.fromARGB(255, 0, 0, 0),
                      child: Container(
                        width: 80,
                  ...
                  MouseRegion(
                    ...
                    child: InkWell(
                      onTap: () {
                        launch('https://www.elaros.com/solutions/the-digital-bladder-diary/');
                      },
                      splashColor: const Color.fromARGB(255, 0, 0, 0),
                      child: Container(
                        width: 80,
